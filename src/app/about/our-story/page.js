    ...
    return (
        <main>
            <section className="about-header our-story-header">
                <h2>{language === "English" ? "Saving Animals Together" : ""}</h2>
            </section>
            <section className="about-body">
                <div className="about-content">
                    <p>
                        <strong>{language === "English" ? "Fragile Planet Wildlife Park" : ""}</strong>{language === "English" ? ", LLC was established in 2021 in Los Fresnos, Texas. Opening its doors in the summer of 2021 with a diverse collection of animals, the park has grown rapidly, offering unforgettable experiences to its guests. From its inception, Fragile Planet has been dedicated to providing educational, up-close encounters with wildlife, emphasizing the importance of conservation and animal welfare. The park continually expands its collection and educational programs, aiming to become a leading ecotourism and zoological attraction in the Rio Grande Valley (RGV)." : ""}
                    </p>
                    <p>
                        <strong>{language === "English" ? "Early Beginnings" : ""}</strong>
                    </p>
                    <p>
                    ...
                    <p>
                        <strong>{language === "English" ? "Growth and Expansion" : ""}</strong>
                    </p>
                    <p>
                        {language === "English" ? "Fragile Planet Wildlife Park actively participates in local and global conservation efforts. The parks leadership sit in positions on esteemed non profit organizations such as Kids Saving the Rainforest. This NGO has been proving care and support to rainforest and marine animals for the last 25 years, in Manuel Antonio, Costa Rica. A future goal is to begin construction on a state of the art wildlife hospital that can assist the unique animals of the RGV." : ""}
                    </p>
                    <p>
                        <strong>{language === "English" ? "Conservation and Community Engagement" : ""}</strong>
                    </p>
                    <p>
                    ...
                    <p>
                        <strong>{language === "English" ? "Future Goals" : ""}</strong>
                    </p>
                    <p>
