    ...
    return (
        <main className="our-team">
            <section className="about-header our-team-header">
                <h2>{language === "English" ? "Meet our team" : ""}</h2>
            </section>
            <section className="about-body">
                <div className="about-content">
                    ...
                    <div className="team-member">
                        ...
                        <p className="employee-title">{language === "English" ? "Safari Guide" : ""}</p>
                    </div>
                    <div className="team-member">
                        <Image className="employee-img" alt="employee" src={employee4} />
                        <p className="employee-name">Jorge Garcia</p>
                        <p className="employee-title">{language === "English" ? "Lead Educator" : ""}</p>
                    </div>
                    <div className="team-member">
